...
var browserAugmentation = exports.browserAugmentation = function(dom, options) {
  ...
  dom.Element.prototype.__defineGetter__('innerHTML', function() {
    if (this._tagName === 'script' && this._attributes.length > 0 && typeof(this._attributes._nodes.type) !== "undefined" && this._attributes._nodes.type._nodeValue.indexOf("text/javascript") === -1){
